...
filterBankHarris = dictionaryHarris.filterBank;
filterBankRandom = dictionaryRandom.filterBank;
...
%     wordRepresentation{i} = getVisualWords(image, filterBank, dictionary');
    wordRepresentationHarris{i} = getVisualWords(image, filterBankHarris, dictionaryHarris);
    wordRepresentationRandom{i} = getVisualWords(image, filterBankRandom, dictionaryRandom);
...
%     save([target, strrep(all_imagenames{i},'.jpg','.mat')],'wordMap');
    ...
    save(['../data/harris/', strrep(all_imagenames{i},'.jpg','.mat')],'wordMap');
    wordMap = wordRepresentationRandom{i};
    save(['../data/random/', strrep(all_imagenames{i},'.jpg','.mat')],'wordMap');
